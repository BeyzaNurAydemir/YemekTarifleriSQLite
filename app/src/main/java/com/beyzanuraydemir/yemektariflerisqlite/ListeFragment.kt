...
class ListeFragment : Fragment() {
    ...
    //Verileri recyclerview içinde gösterebilmek için arraylist tanımlarız.
    var yemekIsmiListesi = ArrayList<String>()
    var yemekIdListesi = ArrayList<Int>()
    //Liste için adapter oluştur
    ...
    fun sqlVeriAlma(){
        try{
            activity?.let {
                ...
                yemekIsmiListesi.clear() //önceden herhangi bir şey varsa temizle
                ...
                //yeni veri geldiğni listemize söyleyelim
